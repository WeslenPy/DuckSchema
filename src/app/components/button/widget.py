...
from src.app.components.tooltip.widget import ToolTip
from src.app.components.icon.widget import Icon

class PushButton(QPushButton,Icon):
    
    def __init__(self,parent:QMainWindow,name:str,title:str) -> None:
